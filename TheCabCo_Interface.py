...
def login():
    if UserNameEntry.get() == "lakshaybhusan" and PassEntry.get() == "123" or UserNameEntry.get() == "user" or PassEntry.get() == "123" or UserNameEntry.get() == "alex" or PassEntry.get() == "biden69":
